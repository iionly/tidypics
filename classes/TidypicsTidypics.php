<?php
/**
 * Elgg Tidypics class of common functions
 *
 */

class TidypicsTidypics {
	...
	*/
	public static function tp_get_latest_photos($num_images, array $owner_guids = null, $context = 'front') {
	...
	* @return string of html for display
	*/
	public static function tp_get_latest_albums($num_albums, array $container_guids = null, $context = 'front') {
		$prev_context = elgg_get_context();
		elgg_set_context($context);
		$image_html = elgg_list_entities([
			'type' => 'object',
	...
	*/
	public static function tp_get_img_dir($album_guid) {
		$file = new ElggFile();
	...
	* @return type
	*/
	public static function tidypics_prepare_form_vars($entity = null) {
	...
	* @return string
	*/
	public static function tidypics_get_image_libraries() {
		$options = [];
	...
	* @return bool
	*/
	// public static function tidypics_is_upgrade_available() {
	...
	// * @return string
	// */
	// public static function tidypics_list_photos(array $options = []) {
	...
	* @return type
	*/
	public static function tp_guid_callback($row) {
	...
	* @return true/false
	*/
	public static function tp_is_person() {
	...
	* @return bool
	*/
	public static function tidypics_can_add_new_photos(\ElggUser $user = null, \ElggEntity $container = null) {
		if (!isset($user)) {
	...
	public static function tidypics_get_last_log_line($filename) {
		$line = false;
		$f = false;
	...
	public static function tidypics_get_log_location($time) {
		return elgg_get_config('dataroot') . 'tidypics_log' . '/' . $time . '.txt';
	}

	// Return data array for Galleria slideshow
	public static function tidypics_slideshow_json_data($images) {
		$img_array = [];
