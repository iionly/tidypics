...
class TidypicsHooks {
	...
	*/
	public static function tidypics_site_menu(\Elgg\Hook $hook) {
		$menu = $hook->getValue();
	...
	*/
	public static function tidypics_owner_block_menu(\Elgg\Hook $hook) {
		$menu = $hook->getValue();
	...
	*/
	public static function tidypics_entity_menu_setup(\Elgg\Hook $hook) {
		$menu = $hook->getValue();
		$entity = $hook->getParam('entity');
	...
	*/
	public static function tidypics_social_menu_setup(\Elgg\Hook $hook) {
		$menu = $hook->getValue();
	...
	* @return ElggMenuItem[]
	*/
	public static function tidypics_setup_tabs(\Elgg\Hook $hook) {
	...
	*/
	public static function tidypics_widget_urls(\Elgg\Hook $hook) {
		$result = $hook->getValue();
	...
	*/
	public static function tidypics_tool_widgets_handler(\Elgg\Hook $hook) {
	...
	*
	*/
	public static function tidypics_group_permission_override(\Elgg\Hook $hook) {
	...
	*
	*/
	public static function tidypics_notify_message(\Elgg\Hook $hook) {
		$type = $hook->getType();
	...
	*/
	public static function tidypics_walled_garden_override(\Elgg\Hook $hook) {
		$pages = $hook->getValue();
	...
	*/
	public static function tidypics_batch_url_handler(\Elgg\Hook $hook) {
