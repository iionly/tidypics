...
return array (
  ...
  'tidypics:settings:client_resizing' => 'Taille/résolution de l\'image coté client avant le téléversement (EXPÉRIMENTALE!)',
  ...
  'tidypics:settings:resizing_max' => 'Résolution de l\'image maximum autorisée',
  ...
  'tidypics:settings:remove_exif' => 'Enlever les données EXIF de l\'image avant l\'envoi (EXPÉRIMENTALE)',
  ...
  'tidypics:delete_image:no_guid' => 'Il n\'a pas d\'entité Elgg avec ce GUID.',
  ...
  'tidypics:album_select' => 'Avant de commencer l\'envoi de vos photos, vous devez soit sélectionnez un de vos albums soit choisir dans créer un nouveau:',
