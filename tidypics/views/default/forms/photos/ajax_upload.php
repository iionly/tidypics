...
<ul id="tidypics-uploader-steps">
	<li class="mbm">
		<div id="tidypics-uploader">
			...
			<div id="tidypics-flash-uploader">
				<input type="file" id="uploadify" name="uploadify" class="hidden" /> <input type="hidden" name="album_guid" value="<?php echo $album->getGUID(); ?>" /> <input type="hidden" name="batch"
	...
	<li class="mbm"><a id="tidypics-upload-button" class="tidypics-disable" href="#">
